...
static const struct elf32_arm_reloc_map elf32_arm_reloc_map[] =
  {
    ...
    {BFD_RELOC_ARM_MOVW_BREL,	     R_ARM_MOVW_BREL_NC},
    {BFD_RELOC_ARM_MOVT_BREL,	     R_ARM_MOVT_BREL},
    ...
    {BFD_RELOC_ARM_THUMB_MOVW_BREL,  R_ARM_THM_MOVW_BREL_NC},
    {BFD_RELOC_ARM_THUMB_MOVT_BREL,  R_ARM_THM_MOVT_BREL},
