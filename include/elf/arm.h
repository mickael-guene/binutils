...
/* AAELF official names and numbers.  */
  ...
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G0_NC,168)
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G1_NC,169)
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G2_NC,170)
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G3_NC,171)
