...
/* AAELF official names and numbers.  */
  ...
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G3_NC,132)
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G2_NC,133)
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G1_NC,134)
  RELOC_NUMBER (R_ARM_THM_ALU_ABS_G0_NC,135)
